<?php
namespace frontend\helpers\page;
...
class LinkPager extends \yii\widgets\LinkPager{
     ...
     * pageSize style
     */
    public $pageSizeOptions = ['class' => 'form-control','style' => 'display: inline-block;width:auto;margin-top:0px;position: relative;top: -31px;'];

    /**
     * customPage style
     */
    public $customPageOptions = ['class' => 'form-control','style' => 'display: inline-block;margin-top:0px;position: relative;top: -30px;'];
    ...
    protected function renderCustomPage(){
        ...
        return "<li style = 'display: inline-block;width:auto;margin-top:0px;position: relative;top: -30px;'>".$this->customPageBefore."</li>".Html::textInput($this->pagination->pageParam, $page,$this->customPageOptions)."<li style = 'display: inline-block;width:auto;margin-top:0px;position: relative;top: -30px;'>".$this->customPageAfter."</li>";
    }

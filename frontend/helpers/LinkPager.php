...
class LinkPager extends \yii\widgets\LinkPager{
    ...
    protected function renderCustomPage(){
        ...
        return "<li style='display: inline-block;margin-top:0px;position:relative;top:-30px;'>".$this->customPageBefore."</li>".Html::textInput($this->pagination->pageParam, $page,$this->customPageOptions)."<li style='display: inline-block;margin-top:0px;position:relative;top:-30px;'>".$this->customPageAfter."</li>";
    }

...
<br>
          ...
          <div class="box box-widget">
            ...
            <!-- /.box-header -->
            <div class="box-body">
            <div class="box-header">岭南生态农业示范区：<?= ManagementArea::getAreaname($model->management_area)?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;单位：亩</div>
             <table width="100%" border="1" cellpadding="0" cellspacing="0" class="ttpoprint">
			  ...
			  <tr height="30px">
			    <td rowspan="2" align="center">宜农林地<br>
			      面&nbsp;&nbsp;&nbsp;积</td>
			    <td width="9%" rowspan="2" align="center"><?= $farm->contractarea?></td>
			    ...
			    <td width="9%" rowspan="2" align="center">保险<br>
			      面积</td>
			    <td width="9%" rowspan="2" align="center"><?= $model->insuredarea?></td>
			    <td width="9%" align="center">小麦</td>
			    <td width="9%" align="center">大豆</td>
			    <td width="9%"  align="center">其它</td>
			    </tr>
			  ...
			  <tr height="30px">
			    ...
			    <td colspan="10" align="left" valign="top">
			      <p><br>
			        &nbsp;&nbsp;&nbsp;&nbsp;我是岭南生态农业示范区<u><strong><?= $farm->farmname?></strong></u><?php if($model->nameissame) echo '农场承包人';else echo '租赁人';?><u><strong><?php if($model->nameissame) echo $model->farmername;else echo $model->policyholder;?></strong></u> ，自愿参加<?= date('Y')?>年种植业保险，遵守农业保险相关法律、法规和政策性文件，自愿缴纳保费，履行保险协议相关义务，自愿选择保险公司为<u><strong><?= Insurancecompany::find()->where(['id'=>$model->company_id])->one()['companynname']?></strong></u> 。本人保证参保作物品种、种植面积是本人种植和真实有效的，如出现虚假行为由本人承担一切责任。</p>
			        
			        </p><br>
			      <p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;农场名称（盖章）：</p><br>
					<p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;投保人姓名（签字）：</p><br>
					<p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?= datetozhongwen::dateto($model->create_at)?></p><br>
				</td>
			      </tr>
			  ...
			  <tr>
			  	...
			  	<td colspan="10" align="left" valign="top"><p><br><br>
					...
					<table border="0" width="100%">
						<tr>
							<td width="10%">&nbsp;&nbsp;&nbsp;&nbsp;<?= $model->issame?'&radic;':'&Chi;';?></td>
							<td align="left">&nbsp;&nbsp;申报面积与保险面积一致</td>
						</tr>
						<tr>
							<td>&nbsp;&nbsp;&nbsp;&nbsp;<?= $model->isselfselect?'&radic;':'&Chi;'?></td>

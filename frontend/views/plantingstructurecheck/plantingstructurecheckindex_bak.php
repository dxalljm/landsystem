							...
							foreach($plantings as $v) {
								...
								<tr>
									...
									<td align="center"><?php
										...
										echo '&nbsp;&nbsp;';
										echo Html::a('查看详情', '#inputproduct', ['class' => 'btn btn-primary btn-xs','data-toggle'=>"collapse", 'aria-expanded'=>false,'id'=>'product']);
										?>
									</td>
								</tr>
								<tr>
									<td colspan="5">
										<div class="collapse" id="inputproduct" aria-expanded="false" style="height: 0px;">
											<?php
											...
											<tr>
												...
												<td align="center">
													...
													echo Html::a('<span class="glyphicon glyphicon-eye-open"></span>','#hsinputproduct'.$v['id'], [
														'title' => Yii::t('yii', '查看'),
														'data-pjax' => '0',
														'data-toggle'=>"collapse", 'aria-expanded'=>false,'id'=>'hsproduct'.$v['id']
													]);
													echo '&nbsp;&nbsp;';

          ...
          <div class="box box-widget">
            ...
            <div class="box-body">
             <table width="100%" border="1" cellpadding="0" cellspacing="0" class="ttpoprint">
			  ...
			  <tr height="40px">
			    <td align="center">原宗地信息</td><?php $zongdiArray = explode('、', $oldfarm->zongdi);?>
			    <td colspan="5" align="center"><table border="0" width="100%"><?php for($i = 0;$i<=count($zongdiArray);$i++) {
			  ...
			  <tr height="40px">
			    <td align="center">现宗地信息</td><?php $zongdiArray = explode('、', $newfarm->zongdi);?>
			    <td colspan="5" align="center"><table border="0" width="100%"><?php for($i = 0;$i<=count($zongdiArray);$i++) {

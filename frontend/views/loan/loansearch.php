...
//                        'mortgagebank',
              ...
              <?php //var_dump($data->getName('self', 'mortgagebank', 'mortgagebank')->typenameList());?>
				...
				showAllShadow('loan',<?= json_encode(Farms::getManagementArea('small')['areaname'])?>,<?= json_encode($data->getName('self', 'mortgagebank', 'mortgagebank')->typenameList())?>,<?= $data->getName('self', 'mortgagebank', 'mortgagebank')->showAllShadow('sum','mortgagemoney',1,\app\models\Theyear::getYearArray($_GET['begindate'],$_GET['enddate']))?>,'元');

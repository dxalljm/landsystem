			...
			<div class="col-xs-12">
				<div class="box">
					<div class="box-header">
                        ...
                        业务办理&nbsp;&nbsp;<?php if(User::getItemname() == '主任' or User::getItemname() == '地产科科长' or User::getItemname() == '法规科科长') {?><?= html::a('农场档案打印',Url::to(['print/printfarmsfile','farms_id'=>$farm->id]),['class'=>'btn btn-primary'])?>&nbsp;&nbsp;
                        <?= html::a('承包合同打印',Url::to(['print/printcontract','farms_id'=>$farm->id]),['class'=>'btn btn-primary'])?>&nbsp;&nbsp;<?php }?>
                    </h3>

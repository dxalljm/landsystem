  ...
  <table width="100%" border="0">
    ...
    <td width="46%" valign="top"><table width="104%" height="458px"
      ...
      <tr>
			...
			<td  align='left'><?= html::textInput('oldcontractnumber',$oldFarm->contractnumber,['id'=>'oldfarms-contractnumber','readonly'=>true,'class'=>'form-control','help'=>'ttpo-contract'])?></td>
		</tr>
		<tr>
    ...
    <table width="99%" height="458px" class="table table-bordered table-hover">
      ...
      <tr>
       ...
       <tr>
			<td width=30% align='right'>合同号</td><?php $newFarm->contractnumber = Numberlock::getNumber($_GET['farms_id']);?>
...
//			alert(t);
//			if(t <= 0) {
//				alert('对不起，部分转让合同面积不能为0。');
//				$('#oldfarms-contractarea').val('<?//= $oldFarm->contractarea?>//');
//			}
//		});

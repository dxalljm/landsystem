    ...
    <div class="row">
        <div class="col-xs-12">
            <div class="box">
                ...
                <div class="box-body">
<?php echo Html::a('更新', ['farmsadminupdate','id'=>$_GET['id']], ['class' => 'btn btn-success']) ?>
<?php echo Html::a('返回', ['farmsland'], ['class' => 'btn btn-success']) ?>
<table
...
// 				eval($content = '  宗地号：'.$zongdiinfo->unifiedserialnumber."<br>".'土壤类型：'.$zongdiinfo->agrotype."<br>".'  含石量：'.$zongdiinfo->stonecontent."<br>".'  毛面积：'.$zongdiinfo->grossarea);
        ...
        <tr>
          ...
          <td align='left'><strong>
            <?= $model->notclear?>
            亩</strong></td>
          <td align='right'><?= Farms::notstateInfo($model->notstateinfo)?></td>
          <td align='left'><strong>
            <?= $model->notstate?>
          </strong></td>
        </tr>
        <tr>
          ...
          <td colspan="3"><strong>
            <?= Farms::notstateInfo($model->state)?>
          </strong></td>
        </tr>
        <tr>

  ...
  <table width="100%" height="100%" border="0">
    ...
    <td width="46%" valign="top"><table width="100%" height="100%"
      ...
      <tr>
			...
			<td  align='left'><?= html::textInput('oldcontractnumber',$oldFarm->contractnumber,['id'=>'oldfarms-contractnumber','class'=>'form-control','readonly'=>true,'help'=>'ttpo-contract'])?></td>
		</tr>
		<tr>
			<td width=15% align='right'>承包年限</td>
			<td align='left'>自 <?php echo $oldFarm->begindate;?> 至 <?php echo $oldFarm->enddate;?> 止</td>
		</tr>
		<tr>
      ...
      <?= Html::hiddenInput('ttpoarea',0,['id'=>'ttpozongdi-area']) ?>
        ...
        <td  align='left' valign="middle">
				<?= html::textInput('oldcontractarea',$oldFarm->contractarea,['readonly' => true,'id'=>'oldfarms-contractarea','class'=>'form-control']) ?>
			</td>
        </tr>
      <tr>
        ...
        <td  align='left' valign="middle"><?= html::textInput('oldnotstate',$oldFarm->notstate,['readonly' => true,'id'=>'oldfarms-notstate','class'=>'form-control']) ?></td>
        </tr>
      <tr>
    ...
    <table width="99%" height="100%" class="table table-bordered table-hover">
      <tr>
        ...
        <td  align='left' colspan="2"><?=  $newFarm->farmname?></td>
        </tr>
      <tr>
        <td width="30%" align='right'>承包人姓名</td>
        <td  align='left' colspan="2"><?=  $newFarm->farmername?></td>
        </tr>
      <tr>
        <td width="30%" align='right'>身份证号</td>
        <td  align='left' colspan="2"><?php if(empty($newFarm->cardid)) echo $form->field($newFarm, 'cardid')->textInput(['maxlength' => 500,'readonly'=>false])->label(false)->error(false); else echo $newFarm->cardid;?></td>
        </tr>
      <tr>
        <td width="30%" align='right'>电话号码</td>
        <td  align='left' colspan="2"><?= $form->field($newFarm, 'telephone')->textInput(['maxlength' => 500,'readonly'=>false])->label(false)->error(false) ?></td>
        </tr>
      <tr>
        <td width="30%" align='right'>农场位置</td>
        <td  align='left' colspan="2"><?= $form->field($newFarm, 'address')->textInput(['maxlength' => 500,'readonly'=>false])->label(false)->error(false) ?></td>
        </tr>
        <tr>
       ...
       <tr>
        ...
        <td  align='left' valign="middle" colspan="2"><?=  ManagementArea::find()->where(['id'=>$oldFarm->management_area])->one()['areaname']?></td>
        </tr>
       
		<tr>
			<td width=30% align='right'>原合同号</td>
			<td  align='left' colspan="2"><?= $newFarm->contractnumber?></td>
		</tr>
		<tr>
			<td width=30% align='right'>新合同号</td>
			<td  align='left' colspan="2"><?= $form->field($newFarm, 'contractnumber')->textInput(['maxlength' => 500,'readonly'=>true])->label(false)->error(false) ?></td>
		</tr>
		<tr>
			<td width=30% align='right'>承包年限</td>
			<td align='left' colspan="2">自 <?php echo $newFarm->begindate;?> 至 <?php echo $newFarm->enddate;?> 止</td>
		</tr>
		<tr>
		  <td align='right'>原宗地</td>
		  <td  align='left' colspan="2"><?= $newFarm->zongdi?></td>
		  </tr>
		<tr>
	...
	<span class="dropdown-wrapper" aria-hidden="true"></span>
        ...
        <td  align='left' colspan="2"><?= $form->field($newFarm, 'measure')->textInput(['readonly' => true])->label(false)->error(false) ?></td>
        </tr>
        <tr>
			<td width=30% align='right'>原合同面积</td>
			<td  align='left' colspan="2"><?= $newFarm->contractarea?></td>
		</tr>
        <tr>
        <td align='right'>新合同面积</td>
        <td  align='left' colspan="2"><?= $form->field($newFarm, 'contractarea')->textInput(['readonly' => true])->label(false)->error(false) ?></td>
       </tr>
      <tr>
        <td align='right'>未明确地块面积</td>
        <td  align='left' colspan="2"><?= $form->field($newFarm, 'notclear')->textInput(['readonly' => true])->label(false)->error(false) ?></td>
       </tr>
        <tr>
        <td align='right'>未明确状态面积</td>
        <td  align='left' colspan="2"><?= $form->field($newFarm, 'notstate')->textInput(['readonly' => true])->label(false)->error(false) ?></td>
       </tr>
       <tr>
        <td align='right'>转让未明确地块面积</td><?php if($oldFarm->notclear) $realonly = false; else $realonly = true;?>
        <td  align='left' colspan="2"><?= html::textInput('inputnotclear','',['id'=>'input-notclear','class'=>'form-control','readonly'=>$realonly,'help'=>'ttpo-newnotclear']) ?></td>
       </tr>
      <tr>
        <td align='right'>备注</td>
        <td  align='left' colspan="2"><?= $form->field($newFarm, 'remarks')->textarea(['rows'=>'2'])->label(false)->error(false) ?></td>
        </tr>
    </table></td>
  </tr>
</table>
	...
	if(event.keyCode == 8) {
		...
		if(/^[0-9]{0}([0-9]|[.])+$/.test(input)) {
			if($('#temp_notclear').val() != '') {
				...
				var newresult = $('#temp_notclear').val()*1 + input*1;
				$('#farms-notclear').val(newresult.toFixed(2));
				$('#ttpozongdi-area').val(input);
				toHTH();
			} else {

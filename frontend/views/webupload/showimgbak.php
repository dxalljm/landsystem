    ...
    <style>
        *{list-style:none;border:none;}
        .row {font-family:Arial;background-color:#2C3E50;}
                                ...
                                if(is_array($value2)) {
                                    ...
                                    foreach ($value2 as $key3 => $value3) {
                                        if($class == $value3['table'] and in_array($field, $value3['field'])) {
                                            echo '<li><a href="#" class="active"  data-target="#modal" data-toggle="modal" onclick=openModal('.$farms_id.',"'.$value3['table'].'","'.$value3['field'][array_search($field,$value3['field'])].'")>' . $value3['path'] . '</a></li>';
                                        } else {
                                            echo '<li><a href="#" data-target="#modal" data-toggle="modal" onclick=openModal('.$farms_id.',"'.$value3['table'].'","'.$value3['field'][array_search($field,$value3['field'])].')">' . $value3['path'] . '</a></li>';
                                        }
                                    }
                                    echo '</li>';
                                    echo '</ul>';

...
// 				                    			'disabled' => $disabled,
              ...
              <div class="tab-pane" id="timeline">
                  ...
                  <?php
                  $data = \frontend\helpers\Echartsdata::getCollectionEcharts4($totalData);
//                  var_dump($data);exit;
                  $x = Farms::getManagementArea()['areaname'];
                  echo ES::wdj()->DOM('collectionEcharts',true,'1500px','500px')->options(['legend'=>['应收金额','实收金额'],'xAxis'=>$x,'unit'=>'元','yAxis'=>[],'series'=>[$data['real'],$data['all']]])->JS();
                  ?>
            </div>

...
?>
            <ul class="nav nav-pills nav-pills-warning">
                <li class="active" id="plan"><a href="#planlist" data-toggle="tab" aria-expanded="true">种植业保险计划统计表</a></li>
                <li class="" id="insurance"><a href="#insurancelist" data-toggle="tab" aria-expanded="true">种植业保险统计表</a></li>
                <li class="" id="plantecharts"><a href="#plantechartslist" data-toggle="tab" aria-expanded="false">保险作物图表</a></li>
                <li class="" id="companyecharts"><a href="#companyechartslist" data-toggle="tab" aria-expanded="false">承保公司图表</a></li>
                <li class="" id="insurancenumber"><a href="#insurancenumberlist" data-toggle="tab" aria-expanded="false">农业保险情况图表（数量 ）</a></li>
                <li class="" id="insurancearea"><a href="#insurancearealist" data-toggle="tab" aria-expanded="false">农业保险情况图表（面积）</a></li>
            </ul>
            <div class="tab-content">
                <div class='tab-pane active' id="planlist">
                    <?php
...
//                                      var_dump($series);
                    //                  饼形图,options=['title'=>'某站点用户访问来源','legend'=>['直接访问','邮件营销','联盟广告','视频广告','搜索引擎'],'series'=>[['value'=>335, 'name'=>'直接访问'], ['value'=>310, 'name'=>'邮件营销'], ['value'=>234, 'name'=>'联盟广告'], ['value'=>135, 'name'=>'视频广告'], ['value'=>1548, 'name'=>'搜索引擎']]]
                    echo ES::pie()->DOM('insuranceplant33',true,'1500px','500px')->options(['title' => '种植业保险公司饼形图表','name'=>'保险公司','legend'=>$legend,'series'=>$series,'unit'=>'户'])->JS();
                    ?>
                ...
                <div class="tab-pane" id="insurancenumberlist">
                    ...
                    //                  饼形图,options=['title'=>'某站点用户访问来源','legend'=>['直接访问','邮件营销','联盟广告','视频广告','搜索引擎'],'series'=>[['value'=>335, 'name'=>'直接访问'], ['value'=>310, 'name'=>'邮件营销'], ['value'=>234, 'name'=>'联盟广告'], ['value'=>135, 'name'=>'视频广告'], ['value'=>1548, 'name'=>'搜索引擎']]]
                    echo ES::pie()->DOM('farmsinsuranceinfo',true,'1500px','500px')->options(['title' => '种植业保险数量占比信息','name'=>'保险数量','legend'=>['已参加保险','未参加保险'],'series'=>$series,'unit'=>'户'])->JS();
                    ?>
                ...
                <div class="tab-pane" id="insurancearealist">
                    ...
                    //                  饼形图,options=['title'=>'某站点用户访问来源','legend'=>['直接访问','邮件营销','联盟广告','视频广告','搜索引擎'],'series'=>[['value'=>335, 'name'=>'直接访问'], ['value'=>310, 'name'=>'邮件营销'], ['value'=>234, 'name'=>'联盟广告'], ['value'=>135, 'name'=>'视频广告'], ['value'=>1548, 'name'=>'搜索引擎']]]
                    echo ES::pie()->DOM('farmsinsuranceinfoarea',true,'1500px','500px')->options(['title' => '种植业保险面积占比信息','name'=>'保险面积','legend'=>['已参加保险','未参加保险'],'series'=>$series,'unit'=>'亩'])->JS();
                    ?>
...
echo $tab->createTab(Yii::$app->controller->action->id,['plan','insurance','plantecharts','companyecharts','insurancenumber','insurancearea']);
?>
<script>

...
<div class="nav-tabs-custom">
            <ul class="nav nav-pills nav-pills-warning">
                ...
                <li class=""><a href="#echarts" data-toggle="tab" aria-expanded="true">图表</a></li>
            </ul>
...
//                        ],
                ...
                <div class="tab-pane" id="echarts">
                    <?php
                    $mx = Echartsdata::getMachinetypename($totalData,'typename');
                    $ms = Echartsdata::getMachineinfo($totalData);

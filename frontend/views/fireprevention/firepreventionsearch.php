    ...
    <div class="nav-tabs-custom">
        ...
        'columns' => Search::getColumns(['management_area','farms_id','breedinfo_id','isepidemic','preventionnumber','breedinfonumber','preventionrate']),
              ...
              <?php //var_dump($data->getName('Plant', 'cropname', 'plant_id')->getEchartsData(['*','single',['Plantingstructure',['planting_id','area']]],10000));exit;?>
				...
				showAllShadow('prevention',<?= json_encode(Farms::getManagementArea('small')['areaname'])?>,<?= json_encode($data->getName('Plant', 'cropname', 'plant_id')->typenameList())?>,<?= $data->getName('Plant', 'cropname', 'plant_id')->getEchartsData('volume',10000)?>,'万斤');

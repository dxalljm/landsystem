        ...
        <td>
            <table width="1050px" border="1">
                ...
                <tr>
                    ...
                    <td width="5%" align="center" ><strong>地块</strong></td>
    ...
    <tr>
        <td>
            <table width="1050px" border="1">
                ...
                <tr>
                    <td align="center" height="40"><strong></strong></td>
                    <td align="center"><strong></strong></td>
                    <td align="center"><strong></strong></td>
                    <td align="center" ><strong></strong></td>
                    <td align="center" ><strong></strong></td>
            ...
            <table width="1050px" border="1">
                <tr>
                    <td align="center" rowspan="2" width="10%">
                        <strong>宗地<br>（<?= $zongdiArray['num']?>）</strong>
                    </td>
                </tr>
                <tr>
...
// 			    	echo $i%6;
                ...
                <tr>
                    <td align="center" height="40"><strong>备注</strong></td>

...
<!--		<td colspan="2" align='left'>--><?php //if($farmer) echo Html::img($farmer->photo,['width'=>'180px','height'=>'200px','id'=>'photo']); ?><!--</td>-->
<!--		<td align='left'>身份证扫描件</td>-->
<!--		<td colspan="2" align='left'>--><?php //if($farmer) echo '&nbsp;'.Html::img($farmer->cardpic,['width'=>'400px','height'=>'220px','id'=>'cardpic']); ?><!--</td>-->
<!--		<td colspan="2" align='left'>--><?php //if($farmer) echo '&nbsp;'.Html::img($farmer->cardpicback,['width'=>'400px','height'=>'220px','id'=>'cardpicback']); ?><!--</td>-->
<!--	</tr>-->
<!--</table>-->
<br>
<table class="table">
  <tr>
	  ...
	  <form method="POST" action="--WEBBOT-SELF--" name="form1">
	    ...
	    <option value="100">100</option>;
	      ...
	      <input class="btn btn-xs" type="radio" value="1" name="mode" id="customMode" onClick="selectSfzMode(this)"/><label for="autoMode">自定义</label>
...
jQuery('#selectID').change(function(){
  ...
  function Stop_onclick()
  {
	...
	function UpLoadJPG_onclick()
	{
		...
		var upload = captrue.bUpLoadImage("D:\\JPG.JPG", "192.168.1.10", 80, "/front/uploadimage/upload.php");
// 		alert(save);
		if(upload) {

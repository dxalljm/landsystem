...
<table width="100%" border="1">
  <tr>
    ...
    <td height="31" colspan="5">&nbsp;&nbsp;<?= $farm['farmname'].'('.$model->farmername.')';?><span class="pull-right">账页号:<?= $farm['accountnumber'].'&nbsp;&nbsp;'?></span></td>
    </tr>
  <tr>
...
// 	LODOP.ADD_PRINT_SETUP_BKIMG("http://front.lngwh.gov:8001/front/images/img_2015.jpg");
	...
	LODOP.SET_PRINT_STYLEA(0,"FontSize",10);
	LODOP.ADD_PRINT_TEXT(76,212,400,21,"<?= $model->farmername?>");
	LODOP.SET_PRINT_STYLEA(0,"FontSize",10);

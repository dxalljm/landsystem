...
<?php //$farms = Farms::find()->where(['id'=>$_GET['farms_id']])->one();?>
    ...
    <table class="table table-bordered table-hover">
        ...
        <tr>
            ...
            <td width="" colspan="4"><?= Html::textInput('Lease[accountnumber]','',['id'=>'lease-accountnumber','class'=>'form-control']) ?></td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td align="left" colspan="7"><label><strong><?= Html::checkbox('Lease[isinsurance]',false)?>是否参加保险</strong></label></td>
        </tr>
        <tr>
...
<script>
    ...
    $('#lease-lessee_cardid').change(function () {
        $.getJSON('index.php?r=bankaccount/scancardid',{cardid:$(this).val()},function (data) {
            if(data.state) {
                $('#lease-accountnumber').val(data.number);
            }
        });

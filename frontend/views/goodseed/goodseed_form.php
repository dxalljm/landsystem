...
<td align='left'><?= $form->field($model, 'plant_id')->dropDownList(ArrayHelper::map(Plant::find()->where(['father_id'=>$sonvalue])->all(),'id','cropname'), ['prompt'=>'请选择...'])->label(false)->error(false) ?></td>
</tr>
<tr>
<td width=15% align='right'>农作物型号</td>
<td align='left'><?= $form->field($model, 'plant_model')->textInput(['maxlength' => 500])->label(false)->error(false) ?></td>
</tr>
</table>

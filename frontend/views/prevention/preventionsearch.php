...
?>
    ...
    <div class="nav-tabs-custom">
        ...
        'columns' => Search::getColumns(['management_area','farms_id','farmer_id','breedinfo_id','breedtype_id','isepidemic','preventionnumber','breedinfonumber','preventionrate'],$totalData),
              ...
              <?php //var_dump($data->getName('Breedtype', 'typename', 'breedtype_id')->getEchartsData(['preventionnumber','breedinfonumber'],1,'showShadowThermometer'))?>
                <div id="prevention" style="width: 900px; height: 600px; margin: 0 auto"; ></div>
				<script type="text/javascript">
				showShadowThermometer('prevention',<?= json_encode(Farms::getManagementArea('small')['areaname'])?>,<?= json_encode($data->getName('Breedtype', 'typename', 'breedtype_id')->typenameList())?>,<?= $data->getName('Breedtype', 'typename', 'breedtype_id')->getEchartsData(['preventionnumber','breedinfonumber'],1,'showShadowThermometer')?>,'');

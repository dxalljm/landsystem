...
<div class="machineapply-form">
    ...
    <table class="table table-bordered table-hover">
        <tr>
            <td width="10%" align="center"><strong>机具名称</strong></td>
            <td  align="center"><?= $machine['machinename']?></td>
            <td align="center"><strong>农机品目</strong></td>
            <td align="center"><?= Machinetype::getClass($machine['machinetype_id'])[2]?></td>
            <td width="8%" colspan="" align="center"><strong>型号</strong></td>
            <td align="center" colspan=""><?= $m['implementmodel']?></td>
        </tr>
        <tr>
            <td align="center"><strong>生产厂商</strong></td>
            <td align="center" colspan=""><?= $m['enterprisename']?></td></td>
            <td align="center"><strong>企业所在省份</strong></td>
            <td align="center" colspan=""><?= $m['province']?></td></td>
            <td align="center"><strong>分档名称</strong></td>
            <td align="center" colspan=""><?= $m['filename']?></td></td>
        </tr>
        <tr>
            <td align="center" width="25%"><strong>基本配置及参数</strong></td>
            <td colspan="5" align="left"><?= $m['parameter']?></td>
        </tr>
    </table>
    <?= Farms::showFarmerinfopic($farm['id'])?>

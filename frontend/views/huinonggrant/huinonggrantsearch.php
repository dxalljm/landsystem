...
//               	var_dump($value);exit;
            ...
            <div class="tab-content">
              ...
              wdjHuinong('<?= $classname?>',<?= json_encode(['实发金额','应发金额'])?>,<?= json_encode(Farms::getManagementArea('small')['areaname'])?>,<?= json_encode($echartsData['all'])?>,<?= json_encode($echartsData['real'])?>,'万元');
			</script>
              <!-- /.tab-pane -->
            <!-- /.tab-content -->
            <?php }?>

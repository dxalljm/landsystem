						...
						<div class="box-body">
							...
							<ul class="nav nav-pills nav-pills-warning">
								...
								if(User::getItemname('服务大厅','服务大厅贷款') or User::getItemname('服务大厅','科长') or User::getItemname('地产科') or User::getItemname('项目科') or User::getItemname('管委会领导')) {
									?>
									<li class="active" id="pinfo"><a href="#plantingstructureinfo" data-toggle="tab"
																	 aria-expanded="true">
											<?php
								...
								if(User::getItemname('服务大厅','服务大厅农机申请') or User::getItemname('服务大厅','科长') or User::getItemname('地产科') or User::getItemname('项目科') or User::getItemname('管委会领导')) {
									?>
									<li class="" id="minfo"><a href="#machineinfo" data-toggle="tab"
...
//												],
								...
								if(User::getItemname('服务大厅','服务大厅农机申请') or User::getItemname('服务大厅','科长') or User::getItemname('地产科') or User::getItemname('项目科') or User::getItemname('管委会领导')) {
								?>
								<div class='tab-pane active' id="machineinfo">
									<?php
									echo GridView::widget([
...
<script>
	$(document).ready(function () {
		if($.session.get('tabname') == 'pinfo') {
			$('#pinfo').attr('class','active');
			$('#minfo').attr('class','');

			$('#plantingstructureinfo').attr('class','tab-pane active')
			$('#machineinfo').attr('class','tab-pane')
		}
		if($.session.get('tabname') == 'minfo') {
			$('#pinfo').attr('class','');
			$('#minfo').attr('class','active');

			$('#plantingstructureinfo').attr('class','tab-pane')
			$('#machineinfo').attr('class','tab-pane active')
		}
	})
	$('#pinfo').click(function () {
		$.session.set('tabname', 'pinfo');

	});
	$('#minfo').click(function () {
		$.session.set('tabname', 'minfo');

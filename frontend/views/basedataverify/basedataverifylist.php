    ...
    $(document).ready(function () {
        ...
        var source =
        {
            ...
            datafields: [
                ...
                {name : 'farmeraccountnumber', type: 'string'},
...
//                sortable: true,
                columns: [
                    ...
                    {text : '一卡通账号',datafield :'farmeraccountnumber',width : 200,align:'center',cellsAlign:"center"},
                    ...
                    {text : '一卡通账号',datafield :'accountnumber',width : 200,align:'center',cellsAlign:"center"},
...
//                            return renderstring;
                    ...
                    {text : '小麦C',datafield :'xm',width : 150,align:'center',cellsAlign:"right",cellsformat: 'd2',aggregates: [{ '<b>合计</b>':
                            function (aggregatedValue, currentValue, column, record) {
                                return aggregatedValue+currentValue;
                            }
                        }]
                    },
                    {text : '马铃薯D',datafield :'mls',width : 150,align:'center',cellsAlign:"right",cellsformat: 'd2',aggregates: [{ '<b>合计</b>':
                        function (aggregatedValue, currentValue, column, record) {
                            return aggregatedValue+currentValue;
                        }
                    }]},
                    {text : '杂豆E',datafield :'zd',width : 150,align:'center',cellsAlign:"right",cellsformat: 'd2',aggregates: [{ '<b>合计</b>':
                        function (aggregatedValue, currentValue, column, record) {
                            return aggregatedValue+currentValue;
                        }
                    }]},
                    {text : '北药F',datafield :'by',width : 150,align:'center',cellsAlign:"right",cellsformat: 'd2',aggregates: [{ '<b>合计</b>':
                        function (aggregatedValue, currentValue, column, record) {
                            return aggregatedValue+currentValue;
                        }
                    }]},
                    {text : '蓝莓G',datafield :'lm',width : 150,align:'center',cellsAlign:"right",cellsformat: 'd2',aggregates: [{ '<b>合计</b>':
                        function (aggregatedValue, currentValue, column, record) {
                            return aggregatedValue+currentValue;
                        }
                    }]},
                    {text : '其它H',datafield :'other',width : 150,align:'center',cellsAlign:"right",cellsformat: 'd2',aggregates: [{ '<b>合计</b>':
                        function (aggregatedValue, currentValue, column, record) {
                            return aggregatedValue+currentValue;
                        }
                    }]},
                ...
                columnGroups: [
                    {text : '大豆A', align :'center', name :'dd'},
                    {text : '玉米B', align :'center', name :'ym'},
                ],
            });

 ...
 * @since 2.0
 */
class AppAsset2018 extends AssetBundle
{
    ...
    public $css = [
        ...
        'vendor/bower/MaterialDesign-Webfont-master/css/materialdesignicons.css',
...
//        'vendor/bower/jQuery-tips/css/jq22.css',
        ...
        'vendor/bower/webuploader-master/css/webuploader.css',
        'vendor/bower/webuploader-master/examples/image-upload/style.css',
        'vendor/bower/viewerjs-master/dist/viewer.css',
    ];
...
//        'vendor/bower/AdminLTE/bootstrap/js/bootstrap.bundle.min.js',
        'vendor/bower/webuploader-master/dist/webuploader.js',
        'vendor/bower/viewerjs-master/dist/viewer.js',
//        'vendor/bower/webuploader-master/examples/image-upload/upload.js',
...
//    	'vendor/bower/echarts/build/dist/echarts.min.js',
        'vendor/bower/echarts4/echarts.min.js',

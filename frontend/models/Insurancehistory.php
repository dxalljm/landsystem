...
class Insurancehistory extends \yii\db\ActiveRecord
{
    ...
    public function rules()
    {
        return [
            ...
            [['wheat', 'soybean', 'insuredarea', 'insuredwheat', 'insuredsoybean', 'other', 'insuredother', 'contractarea','insurancearea'], 'number'],
            [['statecontent'], 'string'],
            [['year', 'farmname', 'contractnumber', 'policyholder', 'cardid', 'telephone', 'company_id', 'create_at', 'update_at', 'policyholdertime', 'managemanttime', 'halltime', 'farmername', 'farmerpinyin', 'policyholderpinyin'], 'string', 'max' => 500]
        ];
    }

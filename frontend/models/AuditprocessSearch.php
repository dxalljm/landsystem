...
/**
 * AuditprocessSearch represents the model behind the search form about `app\models\Auditprocess`.
 */
class AuditprocessSearch extends Auditprocess
{
    /**
     * @inheritdoc
     */

...
//				'farms_id' => $farms_id
	...
	public function actionMachineoffarmcomparison($apply_id,$machineoffarm_id,$farms_id)
	{
...
//		$machineapply->save();
		$machinesubsidys = Machinesubsidy::find()->where(['machinetype_id'=>$machineoffarm->machinetype_id,'year'=>User::getYear()])->all();

...
<div class="user-form">
	...
	<div class="form-group">
        <?= Html::submitButton('添加', ['class' => 'btn btn-success','name'=>'assignment-button','value'=>'create']) ?>
         <?= Html::submitButton('删除', ['class' => 'btn btn-primary','name'=>'assignment-button','value'=>'delete']) ?>
    </div>

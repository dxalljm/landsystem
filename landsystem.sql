...
--
-- Host: 127.0.0.1
-- Generation Time: 2015-08-08 03:23:59
-- 服务器版本： 5.6.17
-- PHP Version: 5.5.12
...
('地产科', 'businessindex'),
('系统维护员', 'businessindex'),
('地产科', 'collectioncreate'),
('财务科', 'collectioncreate'),
('地产科', 'collectiondelete'),
('财务科', 'collectiondelete'),
('地产科', 'collectionfarmerlist'),
('财务科', 'collectionfarmerlist'),
('地产科', 'collectionindex'),
('财务科', 'collectionindex'),
('地产科', 'collectionupdate'),
('财务科', 'collectionupdate'),
('地产科', 'collectionview'),
('财务科', 'collectionview'),
('财务科', 'collectionyears'),
('合作社类型', 'cooperativetypecreate'),
('合作社类型', 'cooperativetypedelete'),
('合作社类型', 'cooperativetypeindex'),
('合作社类型', 'cooperativetypeupdate'),
('合作社类型', 'cooperativetypeview'),
('地产科', 'farmercontract'),
('财务科', 'farmercontract'),
('地产科', 'farmercreate'),
('地产科', 'farmsbusiness'),
...
--
-- 表的结构 `land_cooperative`
--

CREATE TABLE IF NOT EXISTS `land_cooperative` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `farms_id` int(11) DEFAULT NULL,
  `cooperativename` varchar(500) DEFAULT NULL,
  `cooperativetype` varchar(500) DEFAULT NULL,
  `directorname` varchar(500) DEFAULT NULL,
  `peoples` int(11) DEFAULT NULL,
  `finance` varchar(500) DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 AUTO_INCREMENT=2 ;

--
-- 转存表中的数据 `land_cooperative`
--

INSERT INTO `land_cooperative` (`id`, `farms_id`, `cooperativename`, `cooperativetype`, `directorname`, `peoples`, `finance`) VALUES
(1, 1, '测试', '', '测试', 20, '');

-- --------------------------------------------------------

--
-- 表的结构 `land_cooperativetype`
--

CREATE TABLE IF NOT EXISTS `land_cooperativetype` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- 转存表中的数据 `land_cooperativetype`
--

INSERT INTO `land_cooperativetype` (`id`, `typename`) VALUES
(4, '农机'),
(5, '畜牧'),
(6, '水利'),
(7, '玉米'),
...
INSERT INTO `land_farmer` (`id`, `farmername`, `cardid`, `farms_id`, `isupdate`, `farmerbeforename`, `nickname`, `gender`, `nation`, `political_outlook`, `cultural_degree`, `domicile`, `nowlive`, `telephone`, `living_room`, `photo`, `cardpic`, `years`, `create_at`, `update_at`) VALUES
(2, '于峰龙', '230231197507182000', 1, 0, '', '', '男', '1', '群众', '初中', '大兴安岭地区加格达奇区', '大兴安岭地区加格达奇区', '13845777100', NULL, 'uploads/1433766705949.jpg', 'uploads/1433766705162.jpg', 2015, NULL, NULL),
(14, '张三', '232700000000000000', 1, 0, '', '', '男', '1', '党员', '研究生', '大兴安岭地区加格达奇区', '大兴安岭地区加格达奇区', '13800000000', NULL, 'uploads/1434784695408.jpg', 'uploads/1434784695840.jpg', 2014, NULL, NULL),
(15, '刘长文', '23022319611023252X', 7, 0, '', NULL, '男', '1', '群众', '初中', '大兴安岭地区加格达奇区', '大兴安岭地区加格达奇区', '15245758533', NULL, 'uploads/1435396611190.jpg', 'uploads/1435396611330.jpg', 2015, NULL, NULL),
(16, '刘长富', '230223196107142000', 8, 0, '', NULL, '男', '1', '群众', '初中', '', '', '', NULL, '', '', 2015, NULL, NULL);

-- --------------------------------------------------------

--
-- 表的结构 `land_farmermembers`
--

CREATE TABLE IF NOT EXISTS `land_farmermembers` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `farmer_id` int(11) DEFAULT NULL,
...
--
-- 转存表中的数据 `land_farmermembers`
--

INSERT INTO `land_farmermembers` (`id`, `farmer_id`, `relationship`, `membername`, `cardid`, `remarks`, `isupdate`) VALUES
(1, 2, '111', '111', '111', '', NULL),
(3, 2, '333', '333', '333', '', NULL);
...
(14, '合作社类型', 'cooperativetype/cooperativetypeindex', NULL);
...
(93, 37, 'farms_id', 'int(11)', '农场ID'),
(94, 37, 'cooperativename', 'varchar(500) null', '合作社名称'),
(95, 37, 'cooperativetype', 'varchar(500) null', '合作社类型'),
(96, 37, 'directorname', 'varchar(500) null', '理事长姓名'),
(97, 37, 'peoples', 'int(11)', '入社人数'),
(98, 37, 'finance', 'varchar(500) null', '财务报表'),
(99, 38, 'farmer_id', 'int(11)', '农场主ID'),
(100, 38, 'relationship', 'varchar(500) null', '关系'),
(101, 38, 'membername', 'varchar(500) null', '姓名'),
(102, 38, 'cardid', 'varchar(500) null', '身份证号'),
(103, 38, 'remarks', 'text', '备注'),
(104, 20, 'create_at', 'varchar(500) null', '创建日期'),
(105, 20, 'update_at', 'varchar(500) null', '更新日期'),
(106, 38, 'isupdate', 'int(11)', '是否可更新'),
(107, 39, 'typename', 'varchar(500) null', '类型名称');
...
(35, 'pesticides', '农药'),
(36, 'goodseed', '良种使用信息'),
(37, 'cooperative', '合作社信息'),
(38, 'farmermembers', '家庭成员'),
(39, 'cooperativetype', '合作社类型');
